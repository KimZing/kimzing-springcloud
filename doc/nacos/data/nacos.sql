...
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='config_info';
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=387 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';

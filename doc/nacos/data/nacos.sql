...
INSERT INTO `config_info` VALUES (195, 'service.vgroupMapping.service-notice-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-07-15 00:30:27', '2020-07-15 00:30:27', NULL, '122.96.121.243', '', 'seata', NULL, NULL, NULL, 'text', NULL);
...
INSERT INTO `config_info` VALUES (259, 'service-storage.yaml', 'DEFAULT_GROUP', 'server:\n  port: 8004\n    \nspring:\n  datasource:\n    # 添加&allowMultiQueries=true使得一个接口可以执行多条语句\n    url: jdbc:mysql://mysql.kimzing.com:3306/springcloud-storage?setUnicode=true&characterEncoding=utf8&allowMultiQueries=true\n    username: root\n    password: 123456\n\nkimzing:\n  web:\n    result:\n      enabled: false\n  minio:\n    # 是否启用minio配置(默认false)\n    enabled: true\n    # minio服务地址\n    url: http://localhost:9000\n    accessKey: admin\n    secretKey: 1234567890\n    # 统一对象前缀\n    prefix: \n    # 前缀类型\n    prefixType: time\n    # 前缀时间的格式\n    timePattern: yyyyMMddHHmmss-', '35a1bef7a83c3ad4360e2386bff29c29', '2020-07-20 12:59:14', '2020-07-21 15:00:23', NULL, '112.80.234.142', '', 'dev', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (262, 'service.vgroupMapping.service-storage-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-07-20 13:04:56', '2020-07-20 13:04:56', NULL, '112.80.234.142', '', 'seata', NULL, NULL, NULL, 'text', NULL);
COMMIT;
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=351 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';

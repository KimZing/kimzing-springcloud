...
) ENGINE=InnoDB AUTO_INCREMENT=573 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='config_info';
...
INSERT INTO `config_info` VALUES (247, 'entry-app-rule.json', 'DEFAULT_GROUP', '[\n    {\n        \"resource\": \"/user/{id}\",\n        \"limitApp\": \"default\",\n        \"grade\": 1,\n        \"count\": 4,\n        \"strategy\": 0,\n        \"controlBehavior\": 0,\n        \"clusterMode\": false\n    }\n]', '9cd93ea1054d45520059789448adacf8', '2020-07-19 19:41:59', '2020-07-25 19:26:54', NULL, '112.80.234.142', '', 'dev', 'app入口限流策略', '', '', 'json', '');
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=704 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';
